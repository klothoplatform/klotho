	...
	}{
		{
			...
			want: coretesting.ResourcesExpectation{
				...
				Deps: []coretesting.StringDep{
					...
					{Source: "aws:eks_node_group:private_t3.medium", Destination: "aws:eks_cluster:test-app-test-cluster"},
					{Source: "aws:eks_node_group:private_t3.medium", Destination: "aws:iam_role:test-app-test-cluster.private_t3.medium"},
					{Source: "aws:eks_node_group:private_t3.medium", Destination: subnet.Id()},
				},
			},
		},
	}
