...
type (
	...
	CloudResourceLink struct {
		Source core.ResourceId `json:"source,omitempty" yaml:"source,omitempty" toml:"source,omitempty"`
		Target core.ResourceId `json:"target,omitempty" yaml:"target,omitempty" toml:"target,omitempty"`
