...
//
//	mockgen --source=./kb.go -destination=./template_kb_mock_test.go -package=knowledgebase
//

// Package knowledgebase is a generated GoMock package.
...
func (m *MockTemplateKB) AddEdgeTemplate(template *EdgeTemplate) error {
	m.ctrl.T.Helper()
...
func (m *MockTemplateKB) AddResourceTemplate(template *ResourceTemplate) error {
	m.ctrl.T.Helper()
...
func (m *MockTemplateKB) AllPaths(from, to construct.ResourceId) ([][]*ResourceTemplate, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "AllPaths", from, to)
	ret0, _ := ret[0].([][]*ResourceTemplate)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockTemplateKB) Edges() ([]graph.Edge[*ResourceTemplate], error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Edges")
	ret0, _ := ret[0].([]graph.Edge[*ResourceTemplate])
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockTemplateKB) GetAllowedNamespacedResourceIds(ctx DynamicValueContext, resourceId construct.ResourceId) ([]construct.ResourceId, error) {
	m.ctrl.T.Helper()
...
func (m *MockTemplateKB) GetClassification(id construct.ResourceId) Classification {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetClassification", id)
	ret0, _ := ret[0].(Classification)
	return ret0
}
...
func (m *MockTemplateKB) GetEdgeTemplate(from, to construct.ResourceId) *EdgeTemplate {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetEdgeTemplate", from, to)
	ret0, _ := ret[0].(*EdgeTemplate)
	return ret0
}
...
func (m *MockTemplateKB) GetModel(model string) *Model {
	m.ctrl.T.Helper()
...
func (m *MockTemplateKB) GetPathSatisfactionsFromEdge(source, target construct.ResourceId) ([]EdgePathSatisfaction, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetPathSatisfactionsFromEdge", source, target)
	ret0, _ := ret[0].([]EdgePathSatisfaction)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockTemplateKB) GetResourceTemplate(id construct.ResourceId) (*ResourceTemplate, error) {
	m.ctrl.T.Helper()
...
func (m *MockTemplateKB) ListResources() []*ResourceTemplate {
	m.ctrl.T.Helper()
