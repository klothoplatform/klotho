...
//
//	mockgen --source=./kb.go -destination=./template_kb_mock_test.go -package=knowledgebase2
//
...
func (m *MockTemplateKB) AllPaths(from, to construct2.ResourceId) ([][]*ResourceTemplate, error) {
	m.ctrl.T.Helper()
...
func (m *MockTemplateKB) GetAllowedNamespacedResourceIds(ctx DynamicValueContext, resourceId construct2.ResourceId) ([]construct2.ResourceId, error) {
	m.ctrl.T.Helper()
...
func (m *MockTemplateKB) GetClassification(id construct2.ResourceId) Classification {
	m.ctrl.T.Helper()
...
func (m *MockTemplateKB) GetEdgeTemplate(from, to construct2.ResourceId) *EdgeTemplate {
	m.ctrl.T.Helper()
...
func (m *MockTemplateKB) GetPathSatisfactionsFromEdge(source, target construct2.ResourceId) ([]EdgePathSatisfaction, error) {
	m.ctrl.T.Helper()
...
func (m *MockTemplateKB) GetResourceTemplate(id construct2.ResourceId) (*ResourceTemplate, error) {
	m.ctrl.T.Helper()
