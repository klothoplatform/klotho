...
func Test_CreateRestApi(t *testing.T) {
	...
	cases := []struct {
	...
	}{
		{
			...
			want: testResult{
				resourceIds: []string{
					"aws:api_deployment:test-test", "aws:api_integration:test-test--GET", "aws:api_method:test-test--GET", "aws:api_resource:test-test-", "aws:api_stage:test-test-$default", "aws:lambda_function:test_test",
				...
				deps: []graph.Edge[string]{
					...
					{Source: "aws:api_resource:test-test-", Destination: "aws:rest_api:test-test"},
					{Source: "aws:api_method:test-test--GET", Destination: "aws:api_resource:test-test-"},
				},
			},
		},
		{
			...
			want: testResult{
				resourceIds: []string{
					"aws:api_deployment:test-test", "aws:api_integration:test-test--GET", "aws:api_integration:test-test--POST", "aws:api_integration:test-test--id--GET",
					"aws:api_integration:test-test-test-GET", "aws:api_integration:test-test-test-POST", "aws:api_method:test-test--GET", "aws:api_method:test-test--POST", "aws:api_method:test-test--id--GET",
					"aws:api_method:test-test-test-GET", "aws:api_method:test-test-test-POST", "aws:api_resource:test-test-", "aws:api_resource:test-test--id-",
					"aws:api_resource:test-test-test", "aws:api_stage:test-test-$default", "aws:lambda_function:test_test",
				...
				deps: []graph.Edge[string]{
					{Source: "aws:api_integration:test-test--POST", Destination: "aws:api_method:test-test--POST"},
					{Source: "aws:api_integration:test-test--POST", Destination: "aws:lambda_function:test_test"},
					...
					{Source: "aws:api_method:test-test--id--GET", Destination: "aws:api_resource:test-test--id-"},
					{Source: "aws:api_integration:test-test--id--GET", Destination: "aws:api_method:test-test--id--GET"},
					{Source: "aws:api_integration:test-test--id--GET", Destination: "aws:lambda_function:test_test2"},
					{Source: "aws:api_deployment:test-test", Destination: "aws:rest_api:test-test"},
					{Source: "aws:api_integration:test-test--GET", Destination: "aws:api_method:test-test--GET"},
					{Source: "aws:api_integration:test-test--GET", Destination: "aws:lambda_function:test_test"},
					{Source: "aws:api_integration:test-test--GET", Destination: "aws:lambda_function:test_test2"},
					{Source: "aws:api_stage:test-test-$default", Destination: "aws:api_deployment:test-test"},
					{Source: "aws:api_resource:test-test-", Destination: "aws:rest_api:test-test"},
					{Source: "aws:api_method:test-test--GET", Destination: "aws:api_resource:test-test-"},
					...
					{Source: "aws:api_resource:test-test--id-", Destination: "aws:rest_api:test-test"},
					{Source: "aws:lambda_permission:test_test2_awsrest_apitest_test", Destination: "aws:lambda_function:test_test2"},
					{Source: "aws:lambda_permission:test_test_awsrest_apitest_test", Destination: "aws:lambda_function:test_test"},
					{Source: "aws:api_method:test-test--POST", Destination: "aws:api_resource:test-test-"},
