	...
	}{
		{
			...
			want: coretesting.ResourcesExpectation{
				Nodes: []string{
					...
					"aws:region:region",
					"aws:vpc:test_app",
					"aws:subnet_private:test_app:test_app_test_subnet",
				...
				Deps: []coretesting.StringDep{
					...
					{Source: "aws:eks_cluster:test-app-test-cluster", Destination: "aws:subnet_private:test_app:test_app_test_subnet"},
					...
					{Source: "aws:eks_fargate_profile:test-app-test-cluster", Destination: "aws:subnet_private:test_app:test_app_test_subnet"},
					...
					{Source: "aws:eks_node_group:test-cluster_private_g2", Destination: "aws:subnet_private:test_app:test_app_test_subnet"},
					...
					{Source: "aws:eks_node_group:test-cluster_private_t3_medium", Destination: "aws:subnet_private:test_app:test_app_test_subnet"},
					...
					{Source: "aws:subnet_private:test_app:test_app_test_subnet", Destination: "aws:vpc:test_app"},
					{Source: "aws:eks_cluster:test-app-test-cluster", Destination: "aws:vpc:test_app"},
