...
func Test_CreateRestApi(t *testing.T) {
	...
	cases := []struct {
	...
	}{
		{
			...
			want: testResult{
				resourceIds: []string{
					"aws:api_deployment:test-test", "aws:api_integration:test-test-GET", "aws:api_method:test-test-GET", "aws:api_stage:test-test-stage", "aws:lambda_function:test_test",
		...
		},
		{
			...
			want: testResult{
				resourceIds: []string{
					...
					"aws:api_method:test-test-test/-GET", "aws:api_resource:test-test-test/", "aws:api_resource:test-test-test/-id-/", "aws:api_stage:test-test-stage", "aws:lambda_function:test_test",
