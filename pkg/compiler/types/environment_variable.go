...
type EnvironmentVariable interface {
	GetName() string
	GetConstruct() construct.Construct
	GetValue() string
}
...
func (e environmentVariable) GetConstruct() construct.Construct {
	return e.Construct
}
...
func NewEnvironmentVariable(name string, construct construct.Construct, value string) environmentVariable {
...
var InternalStorageVariable = environmentVariable{
	...
	Construct: &InternalResource{Name: KlothoPayloadName},
