	...
	}{
		{
			...
			want: coretesting.ResourcesExpectation{
				Nodes: []string{
					...
					"aws:vpc_subnet:app_public0",
					"aws:vpc_subnet:app_public1",
					"kubernetes:manifest:app-my-cluster-aws-observability-config-map",
					"kubernetes:manifest:app-my-cluster-aws-observability-ns",
				},
				Deps: []coretesting.StringDep{
					{Source: "aws:eks_cluster:app-my-cluster", Destination: "aws:iam_role:app-my-cluster-ClusterAdmin"},
					{Source: "aws:eks_cluster:app-my-cluster", Destination: "aws:security_group:app"},
					...
					{Source: "aws:vpc_subnet:app_public1", Destination: "aws:vpc:app"},
					{Source: "aws:eks_addon:app-my-cluster-addon-vpc-cni", Destination: "aws:eks_cluster:app-my-cluster"},
					{Source: "kubernetes:manifest:app-my-cluster-aws-observability-config-map", Destination: "aws:eks_cluster:app-my-cluster"},
					{Source: "kubernetes:manifest:app-my-cluster-aws-observability-config-map", Destination: "aws:region:region"},
					{Source: "kubernetes:manifest:app-my-cluster-aws-observability-config-map", Destination: "kubernetes:manifest:app-my-cluster-aws-observability-ns"},
					{Source: "kubernetes:manifest:app-my-cluster-aws-observability-ns", Destination: "aws:eks_cluster:app-my-cluster"},
				},
			},
		},
		{
	...
	}{
		{
			...
			want: coretesting.ResourcesExpectation{
				Nodes: []string{
					...
					"aws:vpc_subnet:app_public1",
					"aws:eks_addon:app-my-cluster-addon-vpc-cni",
					"kubernetes:manifest:app-my-cluster-awmazon-cloudwatch-ns",
					"kubernetes:manifest:app-my-cluster-fluent-bit",
					"kubernetes:manifest:app-my-cluster-fluent-bit-cluster-info-config-map",
				},
				Deps: []coretesting.StringDep{
					{Source: "aws:eks_cluster:app-my-cluster", Destination: "aws:iam_role:app-my-cluster-ClusterAdmin"},
					{Source: "aws:eks_cluster:app-my-cluster", Destination: "aws:security_group:app"},
					...
					{Source: "aws:vpc_subnet:app_public1", Destination: "aws:vpc:app"},
					{Source: "aws:eks_addon:app-my-cluster-addon-vpc-cni", Destination: "aws:eks_cluster:app-my-cluster"},
					{Source: "kubernetes:manifest:app-my-cluster-awmazon-cloudwatch-ns", Destination: "aws:eks_cluster:app-my-cluster"},
					{Source: "kubernetes:manifest:app-my-cluster-fluent-bit", Destination: "aws:eks_cluster:app-my-cluster"},
					{Source: "kubernetes:manifest:app-my-cluster-fluent-bit", Destination: "kubernetes:manifest:app-my-cluster-fluent-bit-cluster-info-config-map"},
					{Source: "kubernetes:manifest:app-my-cluster-fluent-bit-cluster-info-config-map", Destination: "aws:eks_cluster:app-my-cluster"},
					{Source: "kubernetes:manifest:app-my-cluster-fluent-bit-cluster-info-config-map", Destination: "kubernetes:manifest:app-my-cluster-awmazon-cloudwatch-ns"},
				},
			},
		},
		{
