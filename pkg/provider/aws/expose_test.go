	...
	}{
		{
			...
			want: coretesting.ResourcesExpectation{
				...
				Deps: []graph.Edge[string]{
					...
					{Source: "aws:lambda_permission:test_test_awsapi_methodtest_test_GET", Destination: "aws:lambda_function:test-test"},
				},
			},
		},
		{
			...
			want: coretesting.ResourcesExpectation{
				...
				Deps: []graph.Edge[string]{
					...
					{Source: "aws:lambda_permission:test_test_awsapi_methodtest_test_test_POST", Destination: "aws:lambda_function:test-test"},
					{Source: "aws:lambda_permission:test_test2_awsapi_methodtest_test_test_GET", Destination: "aws:api_method:test-test-test/-GET"},
					{Source: "aws:lambda_permission:test_test2_awsapi_methodtest_test_test_GET", Destination: "aws:lambda_function:test-test2"},
					...
					{Source: "aws:lambda_permission:test_test2_awsapi_methodtest_test_test_id__GET", Destination: "aws:lambda_function:test-test2"},
