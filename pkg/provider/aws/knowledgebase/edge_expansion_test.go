	...
	}{
		{
			...
			want: coretesting.ResourcesExpectation{
				Nodes: []string{
					...
					"aws:iam_role:my-app-my-app-rds-proxy-ProxyRole",
					...
					"aws:secret:my-app-my-app-rds-proxy-credentials",
				...
				Deps: []coretesting.StringDep{
					{Source: "aws:iam_policy:my-app-my-app-rds-proxy-ormsecretpolicy", Destination: "aws:secret:my-app-my-app-rds-proxy-credentials"},
					{Source: "aws:iam_role:my-app-my-app-rds-proxy-ProxyRole", Destination: "aws:iam_policy:my-app-my-app-rds-proxy-ormsecretpolicy"},
					...
					{Source: "aws:rds_proxy:my-app-rds-proxy", Destination: "aws:iam_role:my-app-my-app-rds-proxy-ProxyRole"},
					{Source: "aws:rds_proxy:my-app-rds-proxy", Destination: "aws:secret:my-app-my-app-rds-proxy-credentials"},
					...
					{Source: "aws:secret_version:my-app-rds-proxy-credentials", Destination: "aws:secret:my-app-my-app-rds-proxy-credentials"},
		...
		},
		{
			...
			want: coretesting.ResourcesExpectation{
				Nodes: []string{
					...
					"aws:load_balancer:my-app",
					"aws:load_balancer_listener:my-app-tg",
					"aws:rest_api:api",
					"aws:target_group:tg",
					"aws:vpc_link:aws-load_balancer-my-app",
				},
				Deps: []coretesting.StringDep{
					{Source: "aws:api_integration:my-app-/-GET", Destination: "aws:api_method:my-app-/-GET"},
					{Source: "aws:api_integration:my-app-/-GET", Destination: "aws:load_balancer:my-app"},
					{Source: "aws:api_integration:my-app-/-GET", Destination: "aws:rest_api:api"},
					{Source: "aws:api_integration:my-app-/-GET", Destination: "aws:vpc_link:aws-load_balancer-my-app"},
					...
					{Source: "aws:api_integration:my-app-/route/1-GET", Destination: "aws:load_balancer:my-app"},
					{Source: "aws:api_integration:my-app-/route/1-GET", Destination: "aws:rest_api:api"},
					{Source: "aws:api_integration:my-app-/route/1-GET", Destination: "aws:vpc_link:aws-load_balancer-my-app"},
					...
					{Source: "aws:api_integration:my-app-/route/1-POST", Destination: "aws:load_balancer:my-app"},
					{Source: "aws:api_integration:my-app-/route/1-POST", Destination: "aws:rest_api:api"},
					{Source: "aws:api_integration:my-app-/route/1-POST", Destination: "aws:vpc_link:aws-load_balancer-my-app"},
					...
					{Source: "aws:api_integration:my-app-/route/2-POST", Destination: "aws:load_balancer:my-app"},
					{Source: "aws:api_integration:my-app-/route/2-POST", Destination: "aws:rest_api:api"},
					{Source: "aws:api_integration:my-app-/route/2-POST", Destination: "aws:vpc_link:aws-load_balancer-my-app"},
					{Source: "aws:api_method:my-app-/-GET", Destination: "aws:rest_api:api"},
					...
					{Source: "aws:load_balancer_listener:my-app-tg", Destination: "aws:load_balancer:my-app"},
					{Source: "aws:load_balancer_listener:my-app-tg", Destination: "aws:target_group:tg"},
					{Source: "aws:vpc_link:aws-load_balancer-my-app", Destination: "aws:load_balancer:my-app"},
				},
			},
		},
	}
