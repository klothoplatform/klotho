...

		{
			...
			want: coretesting.ResourcesExpectation{
				...
				Deps: []graph.Edge[string]{
					...
					{Source: "aws:nat_gateway:test_private1", Destination: "aws:elastic_ip:test_private1"},
					...
					{Source: "aws:route_table:test_private1", Destination: "aws:nat_gateway:test_private1"},
					...
					{Source: "aws:route_table:test_private2", Destination: "aws:nat_gateway:test_private2"},
