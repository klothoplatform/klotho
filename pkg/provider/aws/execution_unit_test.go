...

		{
			...
			want: coretesting.ResourcesExpectation{
				Nodes: []string{
					...
					"aws:subnet_private:test:test_private1",
					"aws:subnet_private:test:test_private2",
					"aws:subnet_public:test:test_public1",
					"aws:subnet_public:test:test_public2",
				...
				Deps: []coretesting.StringDep{
					...
					{Source: "aws:load_balancer:test-test", Destination: "aws:subnet_private:test:test_private1"},
					{Source: "aws:load_balancer:test-test", Destination: "aws:subnet_private:test:test_private2"},
					...
					{Source: "aws:route_table:test_private1", Destination: "aws:subnet_private:test:test_private1"},
					...
					{Source: "aws:route_table:test_private2", Destination: "aws:subnet_private:test:test_private2"},
					...
					{Source: "aws:subnet_private:test:test_private1", Destination: "aws:availability_zones:AvailabilityZones"},
					{Source: "aws:subnet_private:test:test_private1", Destination: "aws:vpc:test"},
					{Source: "aws:subnet_private:test:test_private2", Destination: "aws:availability_zones:AvailabilityZones"},
					{Source: "aws:subnet_private:test:test_private2", Destination: "aws:vpc:test"},
					{Source: "aws:subnet_public:test:test_public1", Destination: "aws:availability_zones:AvailabilityZones"},
					{Source: "aws:subnet_public:test:test_public1", Destination: "aws:vpc:test"},
					{Source: "aws:subnet_public:test:test_public2", Destination: "aws:availability_zones:AvailabilityZones"},
					{Source: "aws:subnet_public:test:test_public2", Destination: "aws:vpc:test"},
					...
					{Source: "aws:vpc_endpoint:test_lambda", Destination: "aws:security_group:test:test"},
					{Source: "aws:vpc_endpoint:test_lambda", Destination: "aws:subnet_private:test:test_private1"},
					{Source: "aws:vpc_endpoint:test_lambda", Destination: "aws:subnet_private:test:test_private2"},
					...
					{Source: "aws:vpc_endpoint:test_secretsmanager", Destination: "aws:security_group:test:test"},
					{Source: "aws:vpc_endpoint:test_secretsmanager", Destination: "aws:subnet_private:test:test_private1"},
					{Source: "aws:vpc_endpoint:test_secretsmanager", Destination: "aws:subnet_private:test:test_private2"},
					...
					{Source: "aws:vpc_endpoint:test_sns", Destination: "aws:security_group:test:test"},
					{Source: "aws:vpc_endpoint:test_sns", Destination: "aws:subnet_private:test:test_private1"},
					{Source: "aws:vpc_endpoint:test_sns", Destination: "aws:subnet_private:test:test_private2"},
					{Source: "aws:vpc_endpoint:test_sns", Destination: "aws:vpc:test"},
					{Source: "aws:vpc_endpoint:test_sqs", Destination: "aws:region:region"},
					{Source: "aws:vpc_endpoint:test_sqs", Destination: "aws:security_group:test:test"},
					{Source: "aws:vpc_endpoint:test_sqs", Destination: "aws:subnet_private:test:test_private1"},
					{Source: "aws:vpc_endpoint:test_sqs", Destination: "aws:subnet_private:test:test_private2"},
