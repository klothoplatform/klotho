				...
				values: []Value{
					{
						...
						EnvironmentVariable: core.NewEnvironmentVariable("UNIT_PERSIST_ORM_CONNECTION", "persist_orm", "unit", "connection_string"),
					},
				},
			},
		},
				...
				values: []Value{
					{
						...
						EnvironmentVariable: core.NewEnvironmentVariable("UNIT_PERSIST_REDIS_HOST", "persist_redis_node", "unit", "host"),
					},
					{
						ExecUnitName:        "unit",
						Kind:                "Pod",
						...
						EnvironmentVariable: core.NewEnvironmentVariable("UNIT_PERSIST_REDIS_PORT", "persist_redis_node", "unit", "port"),
					},
				},
			},
		},
				...
				values: []Value{
					{
						...
						Type:                string(EnvironmentVariableTransformation),
						Key:                 "UNITPERSISTREDISHOST",
						EnvironmentVariable: core.NewEnvironmentVariable("UNIT_PERSIST_REDIS_HOST", "persist_redis_cluster", "unit", "host"),
					},
					{
						ExecUnitName:        "unit",
						Kind:                "Pod",
						Type:                string(EnvironmentVariableTransformation),
						Key:                 "UNITPERSISTREDISPORT",
						EnvironmentVariable: core.NewEnvironmentVariable("UNIT_PERSIST_REDIS_PORT", "persist_redis_cluster", "unit", "port"),
					},
				},
			},
		},
