...
type CreateCase[P any, R construct.ExpandableResource[P]] struct {
	Name     string
	Existing construct.Resource
	Params   P
...
type ConfigureCase[P any, R construct.ConfigurableResource[P]] struct {
	Name    string
	Params  P
	Want    R
	WantErr bool
