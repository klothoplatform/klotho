		...
		},
		{
			...
			want: coretesting.ResourcesExpectation{
				...
				Deps: []coretesting.StringDep{
					...
					{Source: "aws:lambda_function:my-app-test", Destination: "aws:ecr_image:my-app-test"},
					{Source: "aws:lambda_function:my-app-test", Destination: "aws:iam_role:my-app-test-ExecutionRole"},
					{Source: "aws:lambda_function:my-app-test", Destination: "aws:security_group:my_app:my-app"},
					{Source: "aws:lambda_function:my-app-test", Destination: "aws:subnet_private:my_app:my_app_private0"},
					{Source: "aws:lambda_function:my-app-test", Destination: "aws:subnet_private:my_app:my_app_private1"},
