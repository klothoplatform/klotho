...
func Test_CreateRestApi(t *testing.T) {
	...
	cases := []struct {
	...
	}{
		{
			...
			constructIdToResources: map[string][]core.Resource{
				"execution_unit:test": {
					resources.NewLambdaFunction(unit1, &config.Application{AppName: appName}, &resources.IamRole{}, &resources.EcrImage{}),
				},
			},
			cfg: config.Application{
			...
			want: coretesting.ResourcesExpectation{
				Nodes: []string{
					...
					"aws:lambda_permission:test_test_awsrest_apitest_test",
				...
				Deps: []graph.Edge[string]{
					...
					{Source: "aws:api_integration:test-test-GET", Destination: "aws:lambda_function:test-test"},
					...
					{Source: "aws:lambda_permission:test_test_awsrest_apitest_test", Destination: "aws:rest_api:test-test"},
					{Source: "aws:lambda_permission:test_test_awsrest_apitest_test", Destination: "aws:lambda_function:test-test"},
				},
			},
		},
		{
			...
			constructIdToResources: map[string][]core.Resource{
				...
				"execution_unit:test2": {
					resources.NewLambdaFunction(unit2, &config.Application{AppName: appName}, &resources.IamRole{}, &resources.EcrImage{}),
				},
			},
			cfg: config.Application{
				AppName: appName,
			...
			want: coretesting.ResourcesExpectation{
				Nodes: []string{
					...
					"aws:api_stage:test-test-stage",
					"aws:lambda_function:test-test",
					"aws:lambda_function:test-test2",
					"aws:lambda_permission:test_test2_awsrest_apitest_test",
					"aws:lambda_permission:test_test_awsrest_apitest_test",
					"aws:rest_api:test-test",
				},
				Deps: []graph.Edge[string]{
					...
					{Source: "aws:api_integration:test-test-test/-GET", Destination: "aws:lambda_function:test-test2"},
					...
					{Source: "aws:api_integration:test-test-test/-id-/-GET", Destination: "aws:lambda_function:test-test2"},
					...
					{Source: "aws:api_integration:test-test-test/-POST", Destination: "aws:lambda_function:test-test"},
					...
					{Source: "aws:lambda_permission:test_test2_awsrest_apitest_test", Destination: "aws:lambda_function:test-test2"},
					{Source: "aws:lambda_permission:test_test2_awsrest_apitest_test", Destination: "aws:rest_api:test-test"},
					{Source: "aws:lambda_permission:test_test_awsrest_apitest_test", Destination: "aws:lambda_function:test-test"},
					{Source: "aws:lambda_permission:test_test_awsrest_apitest_test", Destination: "aws:rest_api:test-test"},
				},
			},
