...
//
//	mockgen --source=./kb.go -destination=../engine/operational_eval/template_kb_mock_test.go -package=operational_eval
//
...
func (m *MockTemplateKB) AddEdgeTemplate(template *knowledgebase.EdgeTemplate) error {
	m.ctrl.T.Helper()
...
func (m *MockTemplateKB) AddResourceTemplate(template *knowledgebase.ResourceTemplate) error {
	m.ctrl.T.Helper()
...
func (m *MockTemplateKB) AllPaths(from, to construct.ResourceId) ([][]*knowledgebase.ResourceTemplate, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "AllPaths", from, to)
	ret0, _ := ret[0].([][]*knowledgebase.ResourceTemplate)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockTemplateKB) Edges() ([]graph.Edge[*knowledgebase.ResourceTemplate], error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Edges")
	ret0, _ := ret[0].([]graph.Edge[*knowledgebase.ResourceTemplate])
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockTemplateKB) GetAllowedNamespacedResourceIds(ctx knowledgebase.DynamicValueContext, resourceId construct.ResourceId) ([]construct.ResourceId, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAllowedNamespacedResourceIds", ctx, resourceId)
	ret0, _ := ret[0].([]construct.ResourceId)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockTemplateKB) GetClassification(id construct.ResourceId) knowledgebase.Classification {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetClassification", id)
	ret0, _ := ret[0].(knowledgebase.Classification)
	return ret0
}
...
func (m *MockTemplateKB) GetEdgeTemplate(from, to construct.ResourceId) *knowledgebase.EdgeTemplate {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetEdgeTemplate", from, to)
	ret0, _ := ret[0].(*knowledgebase.EdgeTemplate)
	return ret0
}
...
func (m *MockTemplateKB) GetModel(model string) *knowledgebase.Model {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetModel", model)
	ret0, _ := ret[0].(*knowledgebase.Model)
	return ret0
}
...
func (m *MockTemplateKB) GetPathSatisfactionsFromEdge(source, target construct.ResourceId) ([]knowledgebase.EdgePathSatisfaction, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetPathSatisfactionsFromEdge", source, target)
	ret0, _ := ret[0].([]knowledgebase.EdgePathSatisfaction)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockTemplateKB) GetResourcePropertyType(resource construct.ResourceId, propertyName string) string {
	m.ctrl.T.Helper()
...
func (m *MockTemplateKB) GetResourceTemplate(id construct.ResourceId) (*knowledgebase.ResourceTemplate, error) {
	m.ctrl.T.Helper()
...
func (m *MockTemplateKB) GetResourcesNamespaceResource(resource *construct.Resource) (construct.ResourceId, error) {
	m.ctrl.T.Helper()
...
func (m *MockTemplateKB) HasDirectPath(from, to construct.ResourceId) bool {
	m.ctrl.T.Helper()
...
func (m *MockTemplateKB) HasFunctionalPath(from, to construct.ResourceId) bool {
	m.ctrl.T.Helper()
...
func (m *MockTemplateKB) ListResources() []*knowledgebase.ResourceTemplate {
	m.ctrl.T.Helper()
