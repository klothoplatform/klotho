...
//
//	mockgen -source=./resource_template.go --destination=../engine/operational_eval/resource_template_mock_test.go --package=operational_eval
//
...
func (m *MockProperty) Clone() knowledgebase2.Property {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Clone")
	ret0, _ := ret[0].(knowledgebase2.Property)
	return ret0
}
...
func (m *MockProperty) Details() *knowledgebase2.PropertyDetails {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Details")
	ret0, _ := ret[0].(*knowledgebase2.PropertyDetails)
	return ret0
}
...
func (m *MockProperty) GetDefaultValue(ctx knowledgebase2.DynamicContext, data knowledgebase2.DynamicValueData) (any, error) {
	m.ctrl.T.Helper()
...
func (m *MockProperty) Parse(value any, ctx knowledgebase2.DynamicContext, data knowledgebase2.DynamicValueData) (any, error) {
	m.ctrl.T.Helper()
...
func (m *MockProperty) SubProperties() knowledgebase2.Properties {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SubProperties")
	ret0, _ := ret[0].(knowledgebase2.Properties)
	return ret0
}
...
func (m *MockProperty) Validate(resource *construct2.Resource, value any, ctx knowledgebase2.DynamicContext) error {
	m.ctrl.T.Helper()
...
func (m *MockMapProperty) Key() knowledgebase2.Property {
	m.ctrl.T.Helper()
...
func (m *MockMapProperty) Value() knowledgebase2.Property {
	m.ctrl.T.Helper()
...
func (m *MockCollectionProperty) Item() knowledgebase2.Property {
	m.ctrl.T.Helper()
