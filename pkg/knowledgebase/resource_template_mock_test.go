...
//
//	mockgen -source=./resource_template.go --destination=./resource_template_mock_test.go --package=knowledgebase
//
...
func (m *MockProperty) Validate(resource *construct.Resource, value any, ctx DynamicContext) error {
	m.ctrl.T.Helper()
