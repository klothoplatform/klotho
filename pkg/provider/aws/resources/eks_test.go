	...
	cases := []struct {
	...
	}{
		{
			...
			want: testResult{
				...
				deps: []stringDep{
					{source: "aws:eks_cluster:test-app-test-cluster", dest: "aws:eks_fargate_profile:test-app-test-cluster"},
					{source: "aws:eks_cluster:test-app-test-cluster", dest: "aws:eks_node_group:test-app-test-cluster"},
					{source: "aws:iam_role:test-app-test-cluster-k8sAdmin", dest: "aws:eks_cluster:test-app-test-cluster"},
					{source: "aws:iam_role:test-app-test-cluster-FargateExecutionRole", dest: "aws:eks_fargate_profile:test-app-test-cluster"},
					{source: "aws:iam_role:test-app-test-cluster-NodeGroupRole", dest: "aws:eks_node_group:test-app-test-cluster"},
				},
			},
		},
	}
